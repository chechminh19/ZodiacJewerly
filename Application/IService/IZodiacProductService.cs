...
namespace Application.IService
{
    ...
    {
        Task<ServiceResponse<PaginationModel<ZodiacProductDTO>>> GetAllZodiacProduct(int page);
        ...
        Task<ServiceResponse<PaginationModel<ProductDTO>>> GetAllProductsByZodiacId(int zodiacId, int page);
    }
}
